...
class CombatGame {
    ...
    private Player findRoundWinner(final List<Integer> round) {
        return this.players.get(round.indexOf(Collections.max(round)));
    }
    ...
    int play() {
        ...
        while (winner == null) {
            ...
            Player roundWinner = this.findRoundWinner(round);
    ...
    int playRecursive() {
        return this.recursivePlay().score();
    }
}
